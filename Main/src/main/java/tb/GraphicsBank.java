...
public class GraphicsBank {
    ...
    public GraphicsBank() {
        ...
        baseTileSize = new Dimension2D(DEFAULT_TILE_WIDTH, DEFAULT_TILE_HEIGHT);
    ...
    void saveTileset(File to) throws IOException{
        ...
        w.println("# Tileset");
        w.println("Tile Id, Local Image file path, Tile Name, Type, Relative file path");
